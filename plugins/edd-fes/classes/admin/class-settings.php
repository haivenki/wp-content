	...
	public function edd_settings_panel( $settings ) {
		...
		$sections['main'] = array(
			...
			'fes-dashboard-notification' => array(
				...
				'desc' => __( 'Use this to announce things to your vendors. Appears on the Vendor Dashboard Page once logged in.-Null24.Net', 'edd_fes' ),
				'std' =>  __( 'This is the vendor dashboard. Add welcome text or any other information that is applicable to your vendors.-N U L L 2 4 . N E T', 'edd_fes' )
			),
			'fes-use-css' => array(
				'id'=> 'fes-use-css',
				'type' => 'checkbox',
		...
		$sections['forms'] = array(
			...
			'fes-allow-multiple-purchase-mode' => array(
				...
				'type' => 'checkbox',
				'name' => __( 'Enable Multiple Purchase Mode for all vendor products-Null24.Net', 'edd_fes' ),
