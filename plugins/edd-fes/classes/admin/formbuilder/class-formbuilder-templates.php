...
class FES_Formbuilder_Templates {
	...
	public static function common( $id, $field_name_value = '', $custom_field = true, $values = array(), $force_required = false, $template = 'text' ) {
		...
		<?php if ( $custom_field ) { ?>
			<div class="fes-form-rows">
				...
				<input type="text" name="<?php echo $field_name; ?>" value="<?php echo trim( $field_name_value );?>" data-type="metakey" class="smallipopInput" title="<?php _e( 'Name of the meta key this field will save to', 'edd_fes' ); ?>">
			</div>
		<?php } else { ?>
	...
	public static function standard( $index, $field ) {
		...
		if ( $custom_field && ( isset( $field->supports['permissions']['can_change_meta_key'] ) && $field->supports['permissions']['can_change_meta_key'] ) !== false ) { ?>
			<div class="fes-form-rows">
				<label><?php _e( 'Meta Key', 'edd_fes' ); ?></label>
				<input type="text" name="<?php echo $field_name; ?>" value="<?php echo $field_name_value; ?>" data-type="metakey" class="smallipopInput" title="<?php _e( 'Name of the meta key this field will save to', 'edd_fes' ); ?>">
			</div>
		<?php } else { ?>
			...
			<div class="fes-form-rows">
				...
				<div class="fes-form-sub-fields">
					<label for="<?php esc_attr_e( $field_name ); ?>">
						...
						<?php _e( 'Allows widgets to output data from this field, as well as shows this field\'s value when the FES setting Show Custom Meta is on.', 'edd_fes' ); ?>
					</label>
				</div>
			</div>
			<?php
