			...
			<div class="fes-about-section">
				...
				<div class="feature-section">
					...
					<div class="feature-section-content">
						...
						<p><?php _e( 'Also, all settings have been reviewed to improve clarity and function, making it easier for you to understand exactly what tools you have for managing your marketplace.-Null24.Net', 'edd_fes'); ?></p>
						<h4><?php _e( 'Easy Digital Downloads', 'edd_fes');?></h4>
						<p><?php _e( 'Regardless of its extensive functionality, FES is still an Easy Digital Downloads extension. It\'s only right that FES settings are coupled with EDD settings. The new Settings sub-menu link now leads to a dedicated FES settings tab on the EDD settings page.-Null24.Net', 'edd_fes');?></p>
					</div>
				</div>
			</div>
