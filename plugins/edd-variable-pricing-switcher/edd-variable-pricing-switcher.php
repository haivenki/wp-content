<?php
/*
Plugin Name: Easy Digital Downloads - Variable Pricing Switcher-NULL24.Net
	...
	public function settings( $settings ) {
		$vps_settings = array(
			...
			array(
				...
				'desc'  => __( 'What text should be displayed before the select box-Null 24.Net', 'edd-vps' ),
				'type'  => 'text',
				'size'  => 'regular',
				'std' 	=> 'License'
			),
			array(
				...
				'desc' 	=> __('Check this to disable the cart on the checkout page.-N U LL24.Ne t', 'edd-vps'),
				'type' 	=> 'checkbox'
			),
			array(
